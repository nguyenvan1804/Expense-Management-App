  ...
  String get message {
    switch (code) {
      ...
      case 'invalid-app-credential':
        return 'An internal app credential occurred. Please try again later.';
      case 'user-mismatch':
      ...
      case 'user-token-mismatch':
        return 'The provided user\'s token has a mismatch with the authenticated user\'s user 10.1';
      case 'invalid-message-payload':
        return 'The email template verification message payload is invalid.';
      case 'invalid-sender':
        return 'The email template sender is invalid. Please verify the sender\'s email.t';
      case 'invalid-recipient-email':
        return 'The recipient email address is invalid. Please provide a valid recipient email.';
      case "missing-action-code":
        return "The action code is missing. Please provide a valid action code.";
      case 'user-token-expired':
        return "The user's taken has expired, and authentication is required. Please sign in again.";
